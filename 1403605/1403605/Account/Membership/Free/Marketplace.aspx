                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <asp:DropDownList ID="ddlProducts" runat="server" AutoPostBack="True"
                            DataSourceID="ProductSqlDataSource" DataTextField="Name"
                            DataValueField="ProductId" CssClass="form-control">
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="ProductSqlDataSource" runat="server"
                            ConnectionString='<%$ ConnectionStrings:DBConnectionString %>'
                            SelectCommand="SELECT [ProductId], [Name], [Description], [UnitPrice], [ImageUrl] FROM [Product] ORDER BY [Name]"></asp:SqlDataSource>
                    </div>
                </div>
